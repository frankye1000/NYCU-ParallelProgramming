...
int omp_kmeans(int     is_perform_atomic, /* in: */  //只是要不要atomic
               ...
               float **clusters)          /* out: [numClusters][numCoords] */
{
    ...
    do {
        ...
        if (is_perform_atomic) 
        {
            ...
            /*
            private: private(var) creates a new local copy of var for each thread The value is uninitialized
            firstprivate: The value is initialized==0
            */
